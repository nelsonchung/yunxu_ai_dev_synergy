...
const actionLabels: Record<string, string> = {
  ...
  PROJECT_DOCUMENT_DRAFT_UPDATED: "儲存專案文件草稿",
  ...
  REQUIREMENT_DOCUMENT_DRAFT_UPDATED: "儲存需求文件草稿",
  REQUIREMENT_INTEREST_SENT: "通知客戶需求文件",
  REQUIREMENT_INTEREST_REPLIED: "回覆需求興趣",
