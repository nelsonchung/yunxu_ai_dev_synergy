...
- [x] Project 狀態機：intake -> requirements_signed -> architecture_review -> system_architecture_signed -> software_design_review -> software_design_signed -> implementation -> system_verification_review -> system_verification_signed -> delivery_review -> closed（可跨階段 on_hold / canceled）
